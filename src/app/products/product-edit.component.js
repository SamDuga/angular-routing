...
var ProductEditComponent = /** @class */ (function () {
    ...
    ProductEditComponent.prototype.deleteProduct = function () {
        ...
        if (this.product.id === 0)
            ...
            this.onSaveComplete();
        else if (confirm("Really delete the product: " + this.product.productName + "?"))
    ...
    ProductEditComponent.prototype.validate = function () {
        ...
        if (this.product.productName &&
            ...
            this.dataValid['info'] = true;
        else
            this.dataValid['info'] = false;
        // tags tab
        if (this.product.category &&
            this.product.category.length >= 3)
            this.dataValid['tags'] = true;
        else
            this.dataValid['tags'] = false;
    };
    ProductEditComponent.prototype.isValid = function (path) {
        var _this = this;
        this.validate();
        if (path)
            return this.dataValid[path];
        return (this.dataValid &&
            Object.keys(this.dataValid).every(function (d) { return _this.dataValid[d] === true; }));
    };
